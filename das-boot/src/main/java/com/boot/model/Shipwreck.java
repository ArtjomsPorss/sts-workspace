...
public class Shipwreck {
	...
	@GeneratedValue(strategy= GenerationType.AUTO)	//means auto generated by DB
	Long id;
	// Other fields match database field names thus they don't need to be additionally annotated
	String name;
	String description;
	String condition;
	Integer depth;
